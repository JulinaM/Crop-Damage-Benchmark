...
from crop_damage.models.Encoder_CROMA import CromaEncoder
...
def build_encoder(encoder_cfg) -> nn.Module:
    ...
    raise ValueError(
        f"Unsupported encoder '{encoder_cfg.name}'. Expected one of: 'Terramind', 'Prithvi', 'CROMA', or 'UNet'."
    )
